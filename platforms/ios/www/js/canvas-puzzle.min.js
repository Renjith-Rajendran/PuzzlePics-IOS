...
(function() {
 ...
 var Piece = Cevent.Shape.extend({
                                 ...
                                 outside_square: function(ctx, s, cx, cy) {
                                 ctx.lineTo(cx + s, cy);
                                 },
                                 
                                 inside_square: function(ctx, s, cx, cy) {
                                 ctx.lineTo(cx + s , cy);
                                 },
                                 outside_jigSquare: function (ctx, s, cx, cy) {
                                 ctx.lineTo(cx, cy);
                                 ...
                                 inside_jigSquare: function (ctx, s, cx, cy) {
                                 ctx.lineTo(cx, cy);
                                 ctx.lineTo(cx+s*.3, cy+s*-.1);
                                 ctx.lineTo(cx+s*.5, cy+s*+.2);
                                 ctx.lineTo(cx+s*.7, cy+s*-.1);
                                 ...
                                 outside_jigDiamond: function (ctx, s, cx, cy) {
                                 ctx.lineTo(cx, cy);
                                 ...
                                 inside_jigDiamond: function (ctx, s, cx, cy) {
                                 ctx.lineTo(cx, cy);
                                 ctx.lineTo(cx+s*.3, cy);
                                 ctx.lineTo(cx+s*.5, cy+s*+.2);
                                 ctx.lineTo(cx+s*.7, cy);
                                 ...
                                 outside_curve: function (ctx, s, cx, cy) {
                                 ctx.lineTo(cx, cy);
                                 ctx.bezierCurveTo(cx+s*.3, cy+s*.1,cx+s*.5, cy+s*.1,cx+s, cy);
                                 ctx.lineTo(cx+s, cy);
                                 },
                                 inside_curve: function (ctx, s, cx, cy) {
                                 ctx.lineTo(cx, cy);
                                 ctx.bezierCurveTo(cx+s*.3, cy+s*-.1,cx+s*.5, cy+s*-.1,cx+s, cy);
                                 ctx.lineTo(cx+s, cy);
                                 },
