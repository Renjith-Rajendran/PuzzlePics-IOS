...
(function() {
 ...
 jigsaw.Jigsaw = Class.extend({
                              ...
                              this.ui = new jigsaw.UI(eventBus, opts.defaultPieces || 12);
                              ...
                              this.parts = opts.defaultPieces || 12;
...
(function() {
 ...
 jigsaw.UI = Class.extend({
                   ...
                   // eventBus.on(jigsaw.Events.auto_solve, this.auto_solve.bind(this));
                    },
                    stop_clock: function() {
                    uuid++
                    },
...
(function() {
 jigsaw.Events = {
    ...
    // auto_solve:"AutoSolveEvent"
 }
 })();

/* Play Audio */
function playAudioJoin(url) {
    // Play the audio file at url
    var my_media = new Media(url,
    // success callback
    function () { console.log("playAudioJoin():Audio Success");
    },
    // error callback
    function (err) { console.log("playAudioJoin():Audio Error: " + err); }
    );
    // Play audio
    my_media.play();
